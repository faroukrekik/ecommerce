...
// New method to reset database with new products
exports.resetDatabase = async (req, res) => {
  try {
    ...
    const sampleProducts = [
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=400&h=400&fit=crop",
        description:
          "Fast performance, great value, and Hasselblad camera system",
        rating: "4.5",
        sold: 95,
        quantity: 40,
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&h=400&fit=crop",
        description:
          "Leica optics, powerful processor, and premium build quality",
        rating: "4.4",
        sold: 70,
        quantity: 25,
      },
      ...
      // Laptops
      {
        ...
        description:
          "Professional laptop with M3 chip, Liquid Retina XDR display",
        rating: "4.9",
        sold: 85,
        quantity: 35,
      },
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=400&h=400&fit=crop",
        description:
          "Portable gaming with 7-inch OLED screen and enhanced audio",
        rating: "4.6",
        sold: 150,
        quantity: 60,
      },
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=400&h=400&fit=crop",
        description:
          "Ultra HD video with autofocus and noise-canceling microphone",
        rating: "4.4",
        sold: 95,
        quantity: 45,
      },
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=400&h=400&fit=crop",
        description:
          "25K DPI sensor with programmable buttons and RGB lighting",
        rating: "4.2",
        sold: 200,
        quantity: 100,
      },
    ...
    console.log(
      `✅ Successfully inserted ${insertedProducts.length} new products`
    );
